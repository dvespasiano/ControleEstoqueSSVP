...
describe('Service Tests', () => {
  describe('TbCategoria Service', () => {
    let injector: TestBed;
    let service: TbCategoriaService;
    let httpMock: HttpTestingController;
    let elemDefault: ITbCategoria;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a TbCategoria', () => {
      ...
      it('should update a TbCategoria', () => {
        const returnedFromService = Object.assign(
          {
            idTbCategoria: 1,
            nmCategoria: 'BBBBBB'
      ...
      it('should return a list of TbCategoria', () => {
        const returnedFromService = Object.assign(
          {
            idTbCategoria: 1,
            nmCategoria: 'BBBBBB'
      ...
      it('should delete a TbCategoria', () => {
